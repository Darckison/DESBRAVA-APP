      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-72 bg-white/70 backdrop-blur-md shadow-2xl transform transition-transform duration-300 border-r border-white/20 ${menuLateralAberto ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="p-6 text-center text-green-900 flex flex-col h-full">
            ...
            <div className="flex flex-col gap-4">
                ...
                <button onClick={() => { navigate('/admin-unidades'); setMenuLateralAberto(false); }} className="bg-yellow-500 text-green-950 p-4 rounded-2xl font-black uppercase text-xs shadow-md active:scale-95 hover:bg-yellow-600 transition-colors">🛡️ GERENCIAR UNIDADES</button>
            ...
            <div className="mt-auto pb-6">
                <button onClick={() => navigate('/')} className="w-full bg-red-600 text-white p-4 rounded-2xl font-black uppercase text-xs shadow-md active:scale-95 hover:bg-red-700 transition-colors">SAIR DO SISTEMA</button>
            </div>
        </div>
      </div>
          ...
          <div className="bg-white p-8 md:p-10 rounded-[40px] shadow-2xl border-4 border-green-800 mb-10 animate-in zoom-in-95 duration-300">
            ...
            <form onSubmit={handleSalvar} className="grid grid-cols-1 md:grid-cols-2 gap-6">
               ...
               <div className="md:col-span-2 flex gap-4 mt-4">
                  <button type="submit" disabled={loading} className="bg-green-700 text-white p-5 rounded-2xl font-black flex-1 shadow-xl uppercase transition-all hover:bg-green-800 active:scale-95">{loading ? "PROCESSANDO..." : "Salvar Registro"}</button>
