        ...
        <div className="bg-white p-6 md:p-10 rounded-[32px] shadow-2xl border border-gray-100 mb-10">
          ...
          <form onSubmit={handleSalvar} className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2 flex gap-4 mt-4">
                ...
                <button type="button" onClick={limparFormulario} className="bg-red-600 hover:bg-red-700 text-white px-8 rounded-2xl font-black uppercase">Cancelar</button>
            </div>
          </form>
        </div>
      )}
              ...
              <tbody>
                {membros.map(m => (
                  <tr key={m._id} className="border-b last:border-0 hover:bg-green-50 transition-colors">
                    ...
                    <td className="p-6 text-center font-bold text-gray-500 uppercase text-sm">{m.unidade}</td>
