    ...
    <div className="min-h-screen bg-green-950 bg-gradient-to-b from-green-900 via-green-950 to-black py-4 md:py-12 px-1 md:px-6 font-sans text-white overflow-x-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-16 md:mb-60 px-4">
            ...
            <h1 className="text-xl md:text-7xl font-black uppercase italic flex-1 text-center tracking-tighter text-yellow-500 drop-shadow-[0_2px_15px_rgba(234,179,8,0.5)]">
        ...
        <div className="flex flex-row justify-center items-end gap-1 md:gap-12 mb-24 w-full max-w-5xl mx-auto px-1 relative pt-10 md:pt-24">
          
          {/* 2º LUGAR */}
          {podio[1] && (
            <div className="flex-1 max-w-[105px] md:max-w-[320px] order-1 z-10 transition-all duration-500">
              <div className="bg-white/10 backdrop-blur-xl border-t-2 md:border-t-[6px] border-gray-400 p-1.5 md:p-10 rounded-t-[15px] md:rounded-t-[40px] rounded-b-[40px] md:rounded-b-[100px] shadow-2xl text-center relative border-x border-white/5 overflow-hidden">
                <div className="relative -mt-10 md:-mt-28 mb-3 flex justify-center">
                  ...
                  <span className="absolute -bottom-1.5 bg-gray-400 text-green-950 font-black px-2 md:px-3 py-0.5 md:py-1 rounded-full text-[9px] md:text-xl shadow-lg border border-white/20">2º</span>
                </div>
              ...
              <div className="h-1.5 md:h-4 w-full bg-gray-400/10 blur-md md:blur-xl mt-2 rounded-full opacity-50"></div>
            </div>
          )}

          {/* 1º LUGAR */}
          {podio[0] && (
            <div className="flex-1 max-w-[125px] md:max-w-[380px] order-2 z-20 scale-110 md:scale-125 mb-6 md:mb-20 transition-all duration-500">
              <div className="bg-green-800/40 backdrop-blur-2xl border-t-2 md:border-t-[8px] border-yellow-500 p-2 md:p-14 rounded-t-[20px] md:rounded-t-[50px] rounded-b-[50px] md:rounded-b-[120px] shadow-[0_20px_60px_rgba(234,179,8,0.4)] text-center relative border-x border-yellow-500/20 overflow-hidden">
                <div className="relative -mt-14 md:-mt-40 mb-4 flex justify-center">
                  ...
                  <span className="absolute -bottom-2 md:-bottom-4 bg-yellow-500 text-green-950 font-black px-2 md:px-4 py-0.5 md:py-1.5 rounded-full text-[11px] md:text-2xl shadow-xl border-2 border-yellow-300">1º</span>
                </div>
                <h2 className="font-black text-[10px] md:text-4xl uppercase italic tracking-tighter text-white truncate leading-tight mb-1 px-1">{podio[0].nome.split(' ')[0]}</h2>
              ...
              <div className="h-2 md:h-6 w-full bg-yellow-500/20 blur-xl md:blur-3xl mt-4 rounded-full animate-pulse"></div>
            </div>
          )}

          {/* 3º LUGAR */}
          {podio[2] && (
            <div className="flex-1 max-w-[105px] md:max-w-[320px] order-3 z-10 transition-all duration-500">
              <div className="bg-white/10 backdrop-blur-xl border-t-2 md:border-t-[6px] border-amber-700 p-1.5 md:p-10 rounded-t-[15px] md:rounded-t-[40px] rounded-b-[40px] md:rounded-b-[100px] shadow-2xl text-center relative border-x border-white/5 overflow-hidden">
                <div className="relative -mt-10 md:-mt-28 mb-3 flex justify-center">
                  ...
                  <span className="absolute -bottom-1.5 bg-amber-700 text-white font-black px-2 md:px-3 py-0.5 md:py-1 rounded-full text-[9px] md:text-xl shadow-lg border border-white/20">3º</span>
                </div>
              ...
              <div className="h-1.5 md:h-4 w-full bg-amber-700/10 blur-md md:blur-xl mt-2 rounded-full opacity-50"></div>
            </div>
          )}
        </div>
        ...
        <div className="bg-black/40 backdrop-blur-md rounded-[30px] md:rounded-[60px] overflow-hidden shadow-2xl border border-white/5 mb-20 mx-2 md:mx-0">
          ...
          <div className="divide-y divide-white/5 px-4 md:px-16">
            {geral.map((m, index) => (
              <div key={m._id} className="flex items-center justify-between py-4 md:py-10 hover:bg-white/5 transition-all group">
                <div className="flex items-center gap-3 md:gap-16">
                  <span className="font-black text-white/10 text-xl md:text-6xl w-8 md:w-20 text-center group-hover:text-yellow-500 transition-colors">{index + 4}º</span>
                  <div className="relative">
                    {/* Foto Limpa sem o badge amarelo de posição em cima */}
